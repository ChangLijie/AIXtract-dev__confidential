...
class TestMetrics(unittest.TestCase):
        ...
        self.summary_data = [
            {
                ...
                "Branch Offices": {
                    ...
                    "Europe": {
                        "Email": "eusales@innodisk.com",
                        "Tel": "+31-40-3045-400",
                    },
                    "Japan": {
                        "Email": "jpsales@innodisk.com",
                        "Tel": "+81-45-594-7581",
                    },
                    "China": {
                        "Email": "sales_cn@innodisk.com",
                        "Tel": "+86-755-2167-3689",
                    },
                },
                "Order Information": {
    ...
    def test_get_str_similarity(self):
        ...
        self.assertIsNotNone(metric, "Metric should not be None")
